...
export const PrivacyPolicyPage = ({ extraClass = "" }) => {
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <ol className={styles.ol}>
        <li className={styles.li}>
          <h3 className={`${styles.li_title} text text_type_h3 text_color_black`}>
            1. Общие положения
          </h3>
          <p className="text text_type_medium text_color_black">
            ...
            данных, предпринимаемые ИП Пастернак Александр Александрович (далее
            – Оператор).
          </p>
          <p className="text text_type_medium text_color_black">
        ...
        <li className={styles.li}>
          ...
          <p className="text text_type_medium text_color_black">
            ...
            электронной почты hello@probkishop.ru с пометкой «Отказ от
        ...
        <li className={styles.li}>
          ...
          <p className="text text_type_medium text_color_black">
            ...
            https://probkishop.ru. Заполняя соответствующие формы и/или
        ...
        <li className={styles.li}>
          ...
          <p className="text text_type_medium text_color_black">
            ...
            Оператора hello@probkishop.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p className="text text_type_medium text_color_black">
            ...
            hello@probkishop.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
        </li>
        <li className={styles.li}>
        ...
        <li className={styles.li}>
          ...
          <p className="text text_type_medium text_color_black">
            ...
            к Оператору с помощью электронной почты hello@probkishop.ru.
          </p>
          <p className="text text_type_medium text_color_black">
          ...
          <p className="text text_type_medium text_color_black">
            ...
            сети Интернет по адресу https://probkishop.ru/privacy/.
          </p>
        </li>
      </ol>
    </main>
